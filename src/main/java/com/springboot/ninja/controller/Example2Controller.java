...
public class Example2Controller {
	...
	//Forma 1 
	//localhost:8080/example2/request1?nm=FRANCISCO
	@GetMapping("/request1")
	public ModelAndView request1(@RequestParam(name="nm",required=false,defaultValue="Null") String name ) {
		ModelAndView maw= new ModelAndView(EXAMPLE2_VIEW);
		maw.addObject("nm_in_model",name);
		return maw;
	}
	
	
	//Forma 2
	//localhost:8080/example2/request2/FRANCISCO
